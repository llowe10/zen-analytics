...
py data_sources/statsbomb_tutorial.py
"""
...
# comp.to_csv('C:/Users/lantz/Documents/My Tableau Repository/Datasources/statsbomb/competitions.csv', index=False)

# # Get matches from La Liga 2008/2009
# df = sb.matches(competition_id=11, season_id=41)
# df.to_csv('C:/Users/lantz/Documents/My Tableau Repository/Datasources/statsbomb/matches.csv', index=False)

# Get match events data -> Barcelona 6 - 2 Real Madrid
match = 69249
...
events_df.to_csv('C:/Users/lantz/Documents/My Tableau Repository/Datasources/statsbomb/match_events.csv', index=False)
...
ff_df = pd.concat(ffs)
ff_df.to_csv('C:/Users/lantz/Documents/My Tableau Repository/Datasources/statsbomb/match_shot_freeze_frames.csv', index=False)